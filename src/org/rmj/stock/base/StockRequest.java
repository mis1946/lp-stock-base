...
import org.rmj.stock.pojo.UnitStockRequestDetail;
import org.rmj.stock.pojo.UnitStockRequestMaster;

public class StockRequest implements GTransaction{
    @Override
    public UnitStockRequestMaster newTransaction() {
        UnitStockRequestMaster loObj = new UnitStockRequestMaster();
    ...
    @Override
    public UnitStockRequestMaster loadTransaction(String fsTransNox) {
        UnitStockRequestMaster loObject = new UnitStockRequestMaster();
    ...
    @Override
    public UnitStockRequestMaster saveUpdate(Object foEntity, String fsTransNox) {
        String lsSQL = "";
        
        UnitStockRequestMaster loOldEnt = null;
        UnitStockRequestMaster loNewEnt = null;
        UnitStockRequestMaster loResult = null;
        
        // Check for the value of foEntity
        if (!(foEntity instanceof UnitStockRequestMaster)) {
            setErrMsg("Invalid Entity Passed as Parameter");
            return loResult;
        }
        
        // Typecast the Entity to this object
        loNewEnt = (UnitStockRequestMaster) foEntity;
        ...
        if (fsTransNox.equals("")){
            try {
                ...
                Logger.getLogger(StockRequest.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else{
            try {
    ...
    public boolean deleteTransaction(String fsTransNox) {
        UnitStockRequestMaster loObject = loadTransaction(fsTransNox);
    ...
    public boolean addDetail() {
        UnitStockRequestDetail loDetail = new UnitStockRequestDetail();
    ...
    private boolean saveDetail(String fsTransNox, boolean fbNewRecord) throws SQLException{
        ...
        UnitStockRequestDetail loDetail;
        UnitStockRequestDetail loOldDet;
        int lnCtr;
        String lsSQL;
    ...
    private UnitStockRequestDetail loadTransDetail(String fsTransNox, int fnEntryNox) throws SQLException{
        UnitStockRequestDetail loObj = null;
        ...
        if (!loRS.next()){
            ...
            //load each column to the entity
            loObj = new UnitStockRequestDetail();
            for(int lnCol=1; lnCol<=loRS.getMetaData().getColumnCount(); lnCol++){
    ...
    private ArrayList<UnitStockRequestDetail> loadTransDetail(String fsTransNox) throws SQLException{
        UnitStockRequestDetail loOcc = null;
        Connection loConn = null;
        loConn = setConnection();
        
        ArrayList<UnitStockRequestDetail> loDetail = new ArrayList<>();
        ResultSet loRS = poGRider.executeQuery(
                            MiscUtil.addCondition(getSQ_Detail(), 
                                                    "sTransNox = " + SQLUtil.toSQL(fsTransNox)));
        ...
        loRS.first();
        while(loRS.next()){
            loOcc = new UnitStockRequestDetail();
            //load each column to the entity
            for(int lnCol=1; lnCol<=loRS.getMetaData().getColumnCount(); lnCol++){
    ...
    private ArrayList<UnitStockRequestDetail> poDetail;
